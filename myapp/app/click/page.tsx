          ...
          <>
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                AI-powered analysis. Detect heart conditions quickly and
                accurately using advanced machine learning.
              </p>
            </div>
              ...
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800">
                    For best results, clean the ECG paper surface and ensure
                    there are no obstructions or annotations that might
