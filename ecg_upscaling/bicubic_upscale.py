"""
ECG Image Upscaling using Bicubic Interpolation
------------------------------------------------
This script upscales ECG images using bicubic interpolation algorithm.
...
class ECGUpscaler:
    """
    Class for upscaling ECG images using Bicubic Interpolation
    """
...
def main():
    ...
    print("ECG Image Upscaling using Bicubic Interpolation")
    print("="*60)
    ...
    upscaler = ECGUpscaler(input_dir, output_dir, scale_factor)
